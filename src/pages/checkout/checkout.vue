...
<script lang="ts" src="./checkout.ts"></script>
<template>
  <div class="checkout">
            ...
            <div class="w-full lg:w-1/2 order-2">
              ...
              <form class="mt-8 lg:w-3/4">
                <div>
                  ...
                  <div class="mt-6">
                    ...
                    >
                      ...
                      <span class="text-gray-600 text-sm">$400</span>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <span class="text-gray-600 text-sm">$300</span>
                    </button>
                  </div>
                </div>
                <div class="mt-8">
                  ...
                  <div class="mt-6 flex">
                    <label class="block w-3/12">
                      <select
                        class="form-select text-gray-700 mt-1 block w-full"
                      >
                ...
                <div class="mt-8">
                 ...
                 <b-button  class="sm:w-full padding-t-10" type="is-primary">Checkout</b-button>
                ...
                <div class="border rounded-md max-w-md w-full px-4 py-3">
                  ...
                  <div class="flex justify-between mt-6">
                    <div class="flex">
                      <img
                        class="h-20 w-20 object-cover rounded"
                        src="https://content.7krave.com/restaurants/170/food/3147/a_170_f_7668_3147_medium.jpeg"
                        alt=""
                      />
                      <div class="mx-3">
                        <h3 class="text-sm text-gray-600">Alene Prosacco </h3>
                        <div class="flex items-center mt-2">
                          <button
                            class="text-gray-500 focus:outline-none focus:text-gray-600"
                          >
